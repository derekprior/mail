...
RSpec::Core::RakeTask.new(:rcov) do |t|
  t.pattern = 'test/**/tc_*.rb', 'spec/**/*_spec.rb'
  t.rcov = true
  t.rcov_opts = ['--exclude', '/Library,/opt,/System,/usr']
end
...
RSpec::Core::RakeTask.new(:spec) do |t|
  ...
  t.rspec_opts << "-I #{File.dirname(__FILE__)}/spec"
  t.rspec_opts << "-I #{File.dirname(__FILE__)}/spec/mail"
end
